...
static int _cffi_d_test(int x0)
{
  return test(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_test(PyObject *self, PyObject *arg0)
{
  int x0;
  int result;
...
#else
#  define _cffi_f_test _cffi_d_test
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "test", (void *)_cffi_f_test, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 0), (void *)_cffi_d_test },
};
